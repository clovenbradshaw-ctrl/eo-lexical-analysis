...
*1192 English verbs. 26 reclassified after SUP/REC audit.*
...
| Cell                                               |     n |
|---------------------------------------------------|------:|
| Differentiate × Existence × FIGURE                 |    57 |
| Differentiate × Existence × PATTERN                |     2 |
| Differentiate × Existence × GROUND                 |     8 |
| Differentiate × Structure × FIGURE                 |    66 |
| Differentiate × Structure × PATTERN                |     6 |
| Differentiate × Structure × GROUND                 |     2 |
| Differentiate × Interpretation × FIGURE            |   158 |
| Differentiate × Interpretation × PATTERN           |    15 |
| Differentiate × Interpretation × GROUND            |    30 |
| Relate × Existence × FIGURE                        |    58 |
| Relate × Existence × PATTERN                       |    27 |
| Relate × Existence × GROUND                        |    11 |
| Relate × Structure × FIGURE                        |   112 |
| Relate × Structure × PATTERN                       |    60 |
| Relate × Structure × GROUND                        |    13 |
| Relate × Interpretation × FIGURE                   |    18 |
| Relate × Interpretation × PATTERN                  |     6 |
| Relate × Interpretation × GROUND                   |     6 |
| Generate × Existence × FIGURE                      |   399 |
| Generate × Existence × PATTERN                     |    25 |
| Generate × Existence × GROUND                      |    56 |
| Generate × Structure × FIGURE                      |    24 |
| Generate × Structure × PATTERN                     |     7 |
| Generate × Structure × GROUND                      |     0 |
| Generate × Interpretation × FIGURE                 |    20 |
| Generate × Interpretation × PATTERN                |     5 |
| Generate × Interpretation × GROUND                 |     1 |
|                                                   |      |
| **Total** | **1192** |

**By referent:** FIGURE=912, PATTERN=153, GROUND=127
**By position:** Differentiate=344, Relate=311, Generate=537
**By triad:** Existence=643, Structure=290, Interpretation=259
...
## Differentiate × Existence × FIGURE (57 verbs)
...
## Differentiate × Interpretation × FIGURE (158 verbs)
...
## Differentiate × Interpretation × PATTERN (15 verbs)
...
## Relate × Interpretation × FIGURE (18 verbs)

- blackline [SUP] ⟵ was NUL
- censor [SUP] ⟵ was NUL
- deny [SUP] ⟵ was NUL
- disregard [SUP] ⟵ was NUL
- hedge [SUP]
- hesitate [SUP]
- hide [SUP] ⟵ was NUL
- ignore [SUP] ⟵ was NUL
- interrupt [SUP] ⟵ was NUL
- neglect [SUP] — fail to care for ⟵ was NUL
- overlook [SUP] ⟵ was NUL
- pause [SUP] ⟵ was NUL
- repress [SUP] — suppress or restrain ⟵ was NUL
- stifle [SUP] ⟵ was NUL
- suppress [SUP] ⟵ was NUL
- suspend [SUP] ⟵ was ALT
- unreport [SUP] ⟵ was NUL
- yield [SUP]


## Relate × Interpretation × PATTERN (6 verbs)

- accommodate [SUP] ⟵ was ALT
- conflict [SUP]
- contradict [SUP]
- disagree [SUP]
- range [SUP] ⟵ was ALT
...
## Generate × Existence × FIGURE (399 verbs)
...
## Generate × Existence × GROUND (56 verbs)
...
## Generate × Interpretation × FIGURE (20 verbs)

- deploy [REC] — position strategically
- design [REC] ⟵ was INS
- develop [REC]
- establish [REC] ⟵ was INS
- foster [REC] ⟵ was INS
- grow [REC]
- heal [REC] — restore to health
- implement [REC] ⟵ was INS
- morph [REC]
- rebuild [REC] — build again
- reconsider [REC]
- recover [REC]
- recreate [REC]
- reestablish [REC] ⟵ was INS
- renew [REC]
...
## Generate × Interpretation × GROUND (1 verbs)

- incubate [REC] ⟵ was INS
